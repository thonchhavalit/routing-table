...
export default function Layout() {
  ...
  // const Today = dayjs(now).format("ddd, MMM D, YYYY h:mm A");
  ...
  return (
    <>
      ...
      <div className="parent-main">
        ...
        <div className="footer " style={{ margin: '10px', width: '100%' }}>
          <div className="footer-date">
            <img className="calendarDate" alt="Main" src={calendarDate} />{" "}
            {/* <span>
              <Clock
                date={now} // Pass the raw Date object
                ticking={true}
                // format={"ddd, MMM DD, YYYY h:mm:ss A"} // Format the output
              />
            </span> */}
